    ...
    return (
        <div className='container'>
            <div className='wrapper'>
                ...
                <Button label='%' classStyle='btn' handleOnClick={percent} />
                <Button
                    label='+/-'
                    classStyle='btn'
                ...
                {/* <Button label='0' classStyle='btn' handleOnClick={inputNum} />
                <Button label='.' classStyle='btn' handleOnClick={inputNum} />
                <Button label='=' classStyle='btn orange' handleOnClick={equals} /> */}
